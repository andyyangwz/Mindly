    ...
    <div style={{
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "24px 12px" }}>
          <ListChecks size={28} color={theme.border} style={{ marginBottom: 8 }} />
        ...
        <div style={{
          ...
          overflowY: nextTasks.length > MAX_VISIBLE ? "auto" : "visible",
          marginRight: nextTasks.length > MAX_VISIBLE ? -4 : 0,
          paddingRight: nextTasks.length > MAX_VISIBLE ? 4 : 0,
        }}>
          {nextTasks.map(task => (
