...
import CalendarGrid from "../../scheduling/calendar/CalendarGrid"
import CalendarHeader from "../../scheduling/calendar/CalendarHeader"
  ...
  return (
    <section className="landing-section">
      ...
      <div className="section-container">
        <ScrollReveal>
          <p className="section-label text-center mb-12">{t("landing.calendar.label")}</p>
        </ScrollReveal>

        <ScrollReveal delay={0.1}>
          <h2 className="section-title section-title--center">{t("landing.calendar.title")}</h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          ...
          >
            <div
              className="showcase-calendar showcase-card"
              style={{
        ...
        {showSignup && (
          <div className="showcase-overlay">
            ...
            <h3 className="showcase-overlay-title">{t("landing.calendar.overlayTitle")}</h3>

            <p className="showcase-overlay-desc">{t("landing.calendar.overlayDesc")}</p>
