...
import { Field, In, Pill, Row, Grid, Actions, Error, ErrMsg } from "./formComponents"
...
export default function AddTaskModal({ open, onClose, onSave, editingActivity, selectedSlot, voiceAutofill }) {
  ...
  useEffect(() => {
    ...
    if (voiceAutofill) {
      setForm({
        ...
        eventDate: voiceAutofill.start_date || "",
  ...
  const validate = () => {
    ...
    if (form.eventDate && form.startTime && form.deadlineDate && form.deadlineTime) {
